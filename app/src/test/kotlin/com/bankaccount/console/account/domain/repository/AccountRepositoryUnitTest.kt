...
class AccountRepositoryUnitTest {
    ...
    @Test
    fun `Given an AccountRepository, when create is called, then the account is stored correctly`() {
        val repository = MockAccountRepository()
    ...
    @Test
    fun `Given an AccountRepository, when get is called, then the list of accounts is returned correctly`() {
        val repository = MockAccountRepository()
    ...
    @Test
    fun `Given an AccountRepository, when delete is called, then the account is removed correctly`() {
        val repository = MockAccountRepository()
        val account = DebitAccount(
            id = UUID.randomUUID().toString(),
            userId = UUID.randomUUID().toString(),
    ...
    @Test
    fun `Given an AccountRepository, when update is called, then the account is updated correctly`() {
        val repository = MockAccountRepository()
